...
public class Level_09_Dynamic_Locator extends BaseTest {
	...
	public void User_04_Dynamic_Page_01() {
		...
		addressPage = (UserAddressPageObject) customerInforPage.openPageAtMyAccountArea(driver, "Addresses");
		rewardPointPage = (UserRewardPointPageObject) addressPage.openPageAtMyAccountArea(driver, "Reward points");
		addressPage = (UserAddressPageObject) rewardPointPage.openPageAtMyAccountArea(driver, "Addresses");
		myProductReviewPage = (UserMyProductReviewPageObject) addressPage.openPageAtMyAccountArea(driver, "My product reviews");
		customerInforPage = (UserCustomerInforPageObject) myProductReviewPage.openPageAtMyAccountArea(driver, "Customer info");
	}
